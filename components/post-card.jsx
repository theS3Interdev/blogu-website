...
const PostCard = ({ post }) => {
	return (
		<div className="mb-8 rounded-lg bg-white p-0 pb-12 shadow-lg lg:p-8">
			...
			<h1 className="mb-8 cursor-pointer text-center text-3xl font-semibold transition duration-500 hover:text-sky-500">
			...
			<div className="mb-8 block w-full items-center justify-center text-center lg:flex">
				...
				<div className="font-medium text-gray-800">
					<svg
						...
						className="mr-2 inline h-8 w-8 text-sky-500"
						fill="none"
						viewBox="0 0 24 24"
						stroke="currentColor"
					>
			...
			<div className="text-center">
				<Link href={`/post/${post.slug}`}>
					<span className="ease inline-block transform cursor-pointer rounded-lg bg-sky-500 px-8 py-3 text-lg font-medium text-white transition duration-500 hover:-translate-y-1">
						Continue Reading
					</span>
				</Link>
			</div>
